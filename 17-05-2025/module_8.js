...
// prompt
// function objPrompt() {
//     let result =  prompt("write you name : ");
//     document.write(result);
// }
...
// document.writeln(`${appCodeName}</br>`);
// document.writeln(`${appName}</br>`);
// document.writeln(`${appVersion}</br>`);
// document.writeln(`${cookieEnabled}</br>`);
